...
from src.constants.embedding import MODEL_NAME_TEST
...
embedder.embed_chunks(all=False)


""" chunk_index = "uc202-rex-chunks"
embedding_index = "uc202-rex-embeddings-e5-trained"
...
# Run embedding process
embedder.embed_chunks(all=True)
 """